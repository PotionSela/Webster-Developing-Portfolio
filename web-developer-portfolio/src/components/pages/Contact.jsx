    ...
    <div className="body container-fluid">
      ...
      <form className="row g-3 form" onSubmit={handleFormSubmit}>
        <div className="col-md-6">
          <label className="form-label label">Enter in your name:</label>
          <input
        ...
        <div className="col-md-6">
          <label className="form-label label">Enter in your email:</label>
          <input
            className="inlineInput form-control"
            name="email"
            value={email}
        ...
        <div className="col-md-12">
          <label className="form-label label">Enter in your message:</label>
          <input
